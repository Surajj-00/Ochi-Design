...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20'>
      <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk_X-Cond_SmBd, Roboto, sans-serif"] font-bold' >
        <div className="heading">
          <h1 className='text-[6vw] font-semibold -mb-3 leading-none tracking-tighter'>EYE-</h1>
          <h1 className='text-[6vw] font-semibold -mb-3 leading-none tracking-tighter'>OPENING</h1>
        </div>
      ...
      <div className='w-1/2'>
        <h1 className='text-[6vw] font-semibold -mb-3 leading-none tracking-tighter'>PRESENTATIONS</h1>
          
        <div className="dets font-['Roboto, sans-serif'] mt-20">
